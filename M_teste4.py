...
wave_data['month'] = wave_data.index.month
wave_data['day'] = wave_data.index.day
wave_data['hour'] = wave_data.index.hour

# Group by year, month, day, and hour, aggregating as needed
annual_wave_data = wave_data.groupby(['years', 'month', 'day', 'hour']).agg({
    'pp1d_from_N': 'mean',
    'swh_from_N': 'mean',
    'pp1d_from_NNE': 'mean',
    'swh_from_NNE': 'mean',
    ...
    'pp1d_from_NNW': 'mean',
    'swh_from_NNW': 'mean',
    # Add the rest of your columns with the appropriate aggregation function
    # You can use 'sum', 'mean', 'max', 'min', etc. based on your requirements
    # Example: 'column_name': 'sum'
})

print(annual_wave_data.head())
